...
var SourceExample = function (_PureComponent) {
    _inherits(SourceExample, _PureComponent);

    function SourceExample() {
        _classCallCheck(this, SourceExample);

        return _possibleConstructorReturn(this, (SourceExample.__proto__ || Object.getPrototypeOf(SourceExample)).apply(this, arguments));
    }
